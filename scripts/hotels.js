...
const hotelsData = [
  {
    ...
    price: 2000, // Changed to number
    oldPrice: 3000, // Changed to number
    rating: 4.8,
    stars: 5,
...
function applyFilters() {
  ...
  let filteredHotels = hotelsData.filter(hotel => {
    ...
    // Price filter - Now comparing numbers
  ...
  // Sort hotels - Now comparing numbers
  switch (sortOption) {
    case 'price-low':
    ...
    hotelCard.innerHTML = `
      ...
      return `<span>${icon}</span>`;
        ...
        <div class="price-section">
          <div class="price">
            <span class="current-price">${rupeeSymbol}${hotel.price}</span>
            <span class="old-price">${rupeeSymbol}${hotel.oldPrice}</span>
  ...
  const modalHTML = `
    ...
    `<div class="room-img" style="background-image: url('${img}');"></div>`
                ...
                <div class="room-details">
                  ...
                  <div class="room-price">${rupeeSymbol}${room.price} <span>/night</span></div>
...
function openBookingModal(hotel, room) {
    ...
    <div class="modal-overlay" id="bookingModal">
      <div class="modal-content booking-modal">
        ...
        <div class="booking-hotel-info">
          <h3>${hotel.name}</h3>
          <p>${room.name} - ${rupeeSymbol}${room.price}/night</p>
        </div>
          ...
          <div class="price-summary">
            ...
            <div class="price-details">
              <div class="price-line">
                <span>${rupeeSymbol}${room.price} x <span id="nightsCount">0</span> nights</span>
                <span>${rupeeSymbol}<span id="roomTotal">0</span></span>
              </div>
              <div class="price-line">
                <span>Taxes and fees</span>
                <span>${rupeeSymbol}<span id="taxes">0</span></span>
              </div>
              <div class="price-line total">
                <span>Total</span>
                <span>${rupeeSymbol}<span id="bookingTotal">0</span></span>
              </div>
            </div>
          </div>
 ...
 document.getElementById('bookingForm').addEventListener('submit', function (e) {
    ...
    const adults = document.getElementById("bookingAdults-count").textContent;
    const children = document.getElementById("bookingChildren-count").textContent;
